...
<body class="bg-gray-50">
    ...
    <div class="container mx-auto px-2 sm:px-4 py-6 sm:py-8 max-w-full sm:max-w-4xl">
        ...
        <form id="quizForm" action="practicework.php?typeId=1&topicId=13" method="POST">
            <!-- Question 1 -->
            <div class="question-card bg-white p-4 sm:p-6 rounded-3xl shadow-md border-l-4 border-indigo-500 mb-6" data-aos="fade-up" data-aos-delay="50">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        <p class="text-sm sm:text-lg font-medium text-gray-800 mb-4 hindi-text">मोबाइल की स्क्रीन रिपेयर की जाती हैं I</p>
                        <div class="flex flex-col sm:flex-row gap-2 sm:gap-3">
                            <input type="text" name="257" class="answer-input flex-1 px-3 sm:px-4 py-2 sm:py-3 rounded-lg border border-gray-300 focus:border-indigo-500 outline-none transition" placeholder="Enter Your Answer" aria-label="Translation for question 1">
                        ...
                        <div class="correct-answer mt-4 bg-green-50 border-l-4 border-green-500 p-4 rounded-r">
                            <p class="text-green-700 font-medium flex items-start gap-2">
                                ...
                                <span>Most Appropriate Answer: <span class="font-normal">The mobile screen is being repaired.</span></span>
                            </p>
                        </div>
                        ...
                        <input type="hidden" name="queId[]" value="257">
                    </div>
                </div>
            </div>
            ...
            <div class="question-card bg-white p-4 sm:p-6 rounded-3xl shadow-md border-l-4 border-indigo-500 mb-6" data-aos="fade-up" data-aos-delay="100">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        <p class="text-sm sm:text-lg font-medium text-gray-800 mb-4 hindi-text">मेडल्स जीते जाते हैं I</p>
                        <div class="flex flex-col sm:flex-row gap-2 sm:gap-3">
                            <input type="text" name="258" class="answer-input flex-1 px-3 sm:px-4 py-2 sm:py-3 rounded-lg border border-gray-300 focus:border-indigo-500 outline-none transition" placeholder="Enter Your Answer" aria-label="Translation for question 2">
                        ...
                        <div class="correct-answer mt-4 bg-green-50 border-l-4 border-green-500 p-4 rounded-r">
                            <p class="text-green-700 font-medium flex items-start gap-2">
                                <i class="fas fa-check-circle mt-1 text-green-500"></i>
                                <span>Most Appropriate Answer: <span class="font-normal">Medals are being won.</span></span>
                            </p>
                        </div>
                        <div class="incorrect-answer mt-4 bg-red-50 border-l-4 border-red-500 p-4 rounded-r">
                            <p class="text-red-700 font-medium flex items-start gap-2">
                        ...
                        <input type="hidden" name="queId[]" value="258">
                    </div>
                </div>
            </div>
            ...
            <div class="question-card bg-white p-4 sm:p-6 rounded-3xl shadow-md border-l-4 border-indigo-500 mb-6" data-aos="fade-up" data-aos-delay="150">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        <p class="text-sm sm:text-lg font-medium text-gray-800 mb-4 hindi-text">औरतों को पीटा जा रहा था I</p>
                        <div class="flex flex-col sm:flex-row gap-2 sm:gap-3">
                            <input type="text" name="259" class="answer-input flex-1 px-3 sm:px-4 py-2 sm:py-3 rounded-lg border border-gray-300 focus:border-indigo-500 outline-none transition" placeholder="Enter Your Answer" aria-label="Translation for question 3">
                        ...
                        <div class="correct-answer mt-4 bg-green-50 border-l-4 border-green-500 p-4 rounded-r">
                            <p class="text-green-700 font-medium flex items-start gap-2">
                                <i class="fas fa-check-circle mt-1 text-green-500"></i>
                                <span>Most Appropriate Answer: <span class="font-normal">Women were being beaten.</span></span>
                            </p>
                        </div>
                        <div class="incorrect-answer mt-4 bg-red-50 border-l-4 border-red-500 p-4 rounded-r">
                            <p class="text-red-700 font-medium flex items-start gap-2">
                        ...
                        <input type="hidden" name="queId[]" value="259">
                    </div>
                </div>
            </div>
            ...
            <div class="question-card bg-white p-4 sm:p-6 rounded-3xl shadow-md border-l-4 border-indigo-500 mb-6" data-aos="fade-up" data-aos-delay="200">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        <p class="text-sm sm:text-lg font-medium text-gray-800 mb-4 hindi-text">कुत्ते को नहलाया जा रहा हैं I</p>
                        <div class="flex flex-col sm:flex-row gap-2 sm:gap-3">
                            <input type="text" name="260" class="answer-input flex-1 px-3 sm:px-4 py-2 sm:py-3 rounded-lg border border-gray-300 focus:border-indigo-500 outline-none transition" placeholder="Enter Your Answer" aria-label="Translation for question 4">
                        ...
                        <div class="correct-answer mt-4 bg-green-50 border-l-4 border-green-500 p-4 rounded-r">
                            <p class="text-green-700 font-medium flex items-start gap-2">
                                <i class="fas fa-check-circle mt-1 text-green-500"></i>
                                <span>Most Appropriate Answer: <span class="font-normal">The dog is being bathed.</span></span>
                            </p>
                        </div>
                        <div class="incorrect-answer mt-4 bg-red-50 border-l-4 border-red-500 p-4 rounded-r">
                            <p class="text-red-700 font-medium flex items-start gap-2">
                        ...
                        <input type="hidden" name="queId[]" value="260">
                    </div>
                </div>
            </div>
            ...
            <div class="question-card bg-white p-4 sm:p-6 rounded-3xl shadow-md border-l-4 border-indigo-500 mb-6" data-aos="fade-up" data-aos-delay="250">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        <p class="text-sm sm:text-lg font-medium text-gray-800 mb-4 hindi-text">मेरी साइकिल खराब हो गयी थी I</p>
                        <div class="flex flex-col sm:flex-row gap-2 sm:gap-3">
                            <input type="text" name="261" class="answer-input flex-1 px-3 sm:px-4 py-2 sm:py-3 rounded-lg border border-gray-300 focus:border-indigo-500 outline-none transition" placeholder="Enter Your Answer" aria-label="Translation for question 5">
                        ...
                        <div class="correct-answer mt-4 bg-green-50 border-l-4 border-green-500 p-4 rounded-r">
                            <p class="text-green-700 font-medium flex items-start gap-2">
                                <i class="fas fa-check-circle mt-1 text-green-500"></i>
                                <span>Most Appropriate Answer: <span class="font-normal">My bicycle had broken down.</span></span>
                            </p>
                        </div>
                        <div class="incorrect-answer mt-4 bg-red-50 border-l-4 border-red-500 p-4 rounded-r">
                            <p class="text-red-700 font-medium flex items-start gap-2">
                        ...
                        <input type="hidden" name="queId[]" value="261">
                    </div>
                </div>
            </div>
            ...
            <div class="question-card bg-white p-4 sm:p-6 rounded-3xl shadow-md border-l-4 border-indigo-500 mb-6" data-aos="fade-up" data-aos-delay="300">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        <p class="text-sm sm:text-lg font-medium text-gray-800 mb-4 hindi-text">शादी की गाड़ी सजाई जानी चाहिए थी I</p>
                        <div class="flex flex-col sm:flex-row gap-2 sm:gap-3">
                            <input type="text" name="262" class="answer-input flex-1 px-3 sm:px-4 py-2 sm:py-3 rounded-lg border border-gray-300 focus:border-indigo-500 outline-none transition" placeholder="Enter Your Answer" aria-label="Translation for question 6">
                        ...
                        <div class="correct-answer mt-4 bg-green-50 border-l-4 border-green-500 p-4 rounded-r">
                            <p class="text-green-700 font-medium flex items-start gap-2">
                                <i class="fas fa-check-circle mt-1 text-green-500"></i>
                                <span>Most Appropriate Answer: <span class="font-normal">The wedding car should have been decorated.</span></span>
                            </p>
                        </div>
                        <div class="incorrect-answer mt-4 bg-red-50 border-l-4 border-red-500 p-4 rounded-r">
                            <p class="text-red-700 font-medium flex items-start gap-2">
                        ...
                        <input type="hidden" name="queId[]" value="262">
                    </div>
                </div>
            </div>
            ...
            <div class="question-card bg-white p-4 sm:p-6 rounded-3xl shadow-md border-l-4 border-indigo-500 mb-6" data-aos="fade-up" data-aos-delay="350">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        <p class="text-sm sm:text-lg font-medium text-gray-800 mb-4 hindi-text">खतरा बढ़ रहा था I</p>
                        <div class="flex flex-col sm:flex-row gap-2 sm:gap-3">
                            <input type="text" name="263" class="answer-input flex-1 px-3 sm:px-4 py-2 sm:py-3 rounded-lg border border-gray-300 focus:border-indigo-500 outline-none transition" placeholder="Enter Your Answer" aria-label="Translation for question 7">
                        ...
                        <div class="correct-answer mt-4 bg-green-50 border-l-4 border-green-500 p-4 rounded-r">
                            <p class="text-green-700 font-medium flex items-start gap-2">
                                <i class="fas fa-check-circle mt-1 text-green-500"></i>
                                <span>Most Appropriate Answer: <span class="font-normal">The danger was increasing.</span></span>
                            </p>
                        </div>
                        <div class="incorrect-answer mt-4 bg-red-50 border-l-4 border-red-500 p-4 rounded-r">
                            <p class="text-red-700 font-medium flex items-start gap-2">
                        ...
                        <input type="hidden" name="queId[]" value="263">
                    </div>
                </div>
            </div>
            ...
            <div class="question-card bg-white p-4 sm:p-6 rounded-3xl shadow-md border-l-4 border-indigo-500 mb-6" data-aos="fade-up" data-aos-delay="400">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        <p class="text-sm sm:text-lg font-medium text-gray-800 mb-4 hindi-text">मेहंदी लगाई जाती हैं I</p>
                        <div class="flex flex-col sm:flex-row gap-2 sm:gap-3">
                            <input type="text" name="264" class="answer-input flex-1 px-3 sm:px-4 py-2 sm:py-3 rounded-lg border border-gray-300 focus:border-indigo-500 outline-none transition" placeholder="Enter Your Answer" aria-label="Translation for question 8">
                        ...
                        <div class="correct-answer mt-4 bg-green-50 border-l-4 border-green-500 p-4 rounded-r">
                            <p class="text-green-700 font-medium flex items-start gap-2">
                                <i class="fas fa-check-circle mt-1 text-green-500"></i>
                                <span>Most Appropriate Answer: <span class="font-normal">Henna is being applied.</span></span>
                            </p>
                        </div>
                        <div class="incorrect-answer mt-4 bg-red-50 border-l-4 border-red-500 p-4 rounded-r">
                            <p class="text-red-700 font-medium flex items-start gap-2">
                        ...
                        <input type="hidden" name="queId[]" value="264">
                    </div>
                </div>
            </div>
            ...
            <div class="question-card bg-white p-4 sm:p-6 rounded-3xl shadow-md border-l-4 border-indigo-500 mb-6" data-aos="fade-up" data-aos-delay="450">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        <p class="text-sm sm:text-lg font-medium text-gray-800 mb-4 hindi-text">गाड़ी तुम्हारे द्वारा चलायी जा सकती थी I</p>
                        <div class="flex flex-col sm:flex-row gap-2 sm:gap-3">
                            <input type="text" name="265" class="answer-input flex-1 px-3 sm:px-4 py-2 sm:py-3 rounded-lg border border-gray-300 focus:border-indigo-500 outline-none transition" placeholder="Enter Your Answer" aria-label="Translation for question 9">
                        ...
                        <div class="correct-answer mt-4 bg-green-50 border-l-4 border-green-500 p-4 rounded-r">
                            <p class="text-green-700 font-medium flex items-start gap-2">
                                <i class="fas fa-check-circle mt-1 text-green-500"></i>
                                <span>Most Appropriate Answer: <span class="font-normal">The car could have been driven by you.</span></span>
                            </p>
                        </div>
                        <div class="incorrect-answer mt-4 bg-red-50 border-l-4 border-red-500 p-4 rounded-r">
                            <p class="text-red-700 font-medium flex items-start gap-2">
                        ...
                        <input type="hidden" name="queId[]" value="265">
                    </div>
                </div>
            </div>
            ...
            <div class="question-card bg-white p-4 sm:p-6 rounded-3xl shadow-md border-l-4 border-indigo-500 mb-6" data-aos="fade-up" data-aos-delay="500">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        <p class="text-sm sm:text-lg font-medium text-gray-800 mb-4 hindi-text">प्रथम स्थान उसे नहीं मिलना चाहिए I</p>
                        <div class="flex flex-col sm:flex-row gap-2 sm:gap-3">
                            <input type="text" name="266" class="answer-input flex-1 px-3 sm:px-4 py-2 sm:py-3 rounded-lg border border-gray-300 focus:border-indigo-500 outline-none transition" placeholder="Enter Your Answer" aria-label="Translation for question 10">
                        ...
                        <div class="correct-answer mt-4 bg-green-50 border-l-4 border-green-500 p-4 rounded-r">
                            <p class="text-green-700 font-medium flex items-start gap-2">
                                <i class="fas fa-check-circle mt-1 text-green-500"></i>
                                <span>Most Appropriate Answer: <span class="font-normal">He should not get the first position.</span></span>
                            </p>
                        </div>
                        <div class="incorrect-answer mt-4 bg-red-50 border-l-4 border-red-500 p-4 rounded-r">
                            <p class="text-red-700 font-medium flex items-start gap-2">
                        ...
                        <input type="hidden" name="queId[]" value="266">
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const correctAnswers = {
                '257': 'The mobile screen is being repaired.',
                '258': 'Medals are being won.',
                '259': 'Women were being beaten.',
                '260': 'The dog is being bathed.',
                '261': 'My bicycle had broken down.',
                '262': 'The wedding car should have been decorated.',
                '263': 'The danger was increasing.',
                '264': 'Henna is being applied.',
                '265': 'The car could have been driven by you.',
                '266': 'He should not get the first position.'
            };
