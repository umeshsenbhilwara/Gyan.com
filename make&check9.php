...
<body class="bg-gray-50">
    ...
    <div class="container mx-auto px-2 sm:px-4 py-6 sm:py-8 max-w-full sm:max-w-4xl">
        ...
        <form id="quizForm" action="practicework.php?typeId=1&topicId=12" method="POST">
            <!-- Question 1 -->
            <div class="question-card bg-white p-4 sm:p-6 rounded-3xl shadow-md border-l-4 border-indigo-500 mb-6" data-aos="fade-up" data-aos-delay="50">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        <p class="text-sm sm:text-lg font-medium text-gray-800 mb-4 hindi-text">मैं अपनी समस्या सुलझा चुका हूँ I</p>
                        <div class="flex flex-col sm:flex-row gap-2 sm:gap-3">
                            <input type="text" name="247" class="answer-input flex-1 px-3 sm:px-4 py-2 sm:py-3 rounded-lg border border-gray-300 focus:border-indigo-500 outline-none transition" placeholder="Enter Your Answer" aria-label="Translation for question 1">
                        ...
                        <div class="correct-answer mt-4 bg-green-50 border-l-4 border-green-500 p-4 rounded-r">
                            <p class="text-green-700 font-medium flex items-start gap-2">
                                ...
                                <span>Most Appropriate Answer: <span class="font-normal">I have solved my problem.</span></span>
                            </p>
                        </div>
                        ...
                        <input type="hidden" name="queId[]" value="247">
                    </div>
                </div>
            </div>
            ...
            <div class="question-card bg-white p-4 sm:p-6 rounded-3xl shadow-md border-l-4 border-indigo-500 mb-6" data-aos="fade-up" data-aos-delay="100">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        <p class="text-sm sm:text-lg font-medium text-gray-800 mb-4 hindi-text">गीता फोघाट देश का नाम रोशन कर चुकी हैं I</p>
                        <div class="flex flex-col sm:flex-row gap-2 sm:gap-3">
                            <input type="text" name="248" class="answer-input flex-1 px-3 sm:px-4 py-2 sm:py-3 rounded-lg border border-gray-300 focus:border-indigo-500 outline-none transition" placeholder="Enter Your Answer" aria-label="Translation for question 2">
                        ...
                        <div class="correct-answer mt-4 bg-green-50 border-l-4 border-green-500 p-4 rounded-r">
                            <p class="text-green-700 font-medium flex items-start gap-2">
                                <i class="fas fa-check-circle mt-1 text-green-500"></i>
                                <span>Most Appropriate Answer: <span class="font-normal">Geeta Phogat has brought glory to the country.</span></span>
                            </p>
                        </div>
                        <div class="incorrect-answer mt-4 bg-red-50 border-l-4 border-red-500 p-4 rounded-r">
                            <p class="text-red-700 font-medium flex items-start gap-2">
                        ...
                        <input type="hidden" name="queId[]" value="248">
                    </div>
                </div>
            </div>
            ...
            <div class="question-card bg-white p-4 sm:p-6 rounded-3xl shadow-md border-l-4 border-indigo-500 mb-6" data-aos="fade-up" data-aos-delay="150">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        <p class="text-sm sm:text-lg font-medium text-gray-800 mb-4 hindi-text">पापा ने पुराने हुए सारे मोबाइल एप्स डिलीट कर दिये थे I</p>
                        <div class="flex flex-col sm:flex-row gap-2 sm:gap-3">
                            <input type="text" name="249" class="answer-input flex-1 px-3 sm:px-4 py-2 sm:py-3 rounded-lg border border-gray-300 focus:border-indigo-500 outline-none transition" placeholder="Enter Your Answer" aria-label="Translation for question 3">
                        ...
                        <div class="correct-answer mt-4 bg-green-50 border-l-4 border-green-500 p-4 rounded-r">
                            <p class="text-green-700 font-medium flex items-start gap-2">
                                <i class="fas fa-check-circle mt-1 text-green-500"></i>
                                <span>Most Appropriate Answer: <span class="font-normal">Dad had deleted all the outdated mobile apps.</span></span>
                            </p>
                        </div>
                        <div class="incorrect-answer mt-4 bg-red-50 border-l-4 border-red-500 p-4 rounded-r">
                            <p class="text-red-700 font-medium flex items-start gap-2">
                        ...
                        <input type="hidden" name="queId[]" value="249">
                    </div>
                </div>
            </div>
            ...
            <div class="question-card bg-white p-4 sm:p-6 rounded-3xl shadow-md border-l-4 border-indigo-500 mb-6" data-aos="fade-up" data-aos-delay="200">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        <p class="text-sm sm:text-lg font-medium text-gray-800 mb-4 hindi-text">मैं सारे कारतूस फाड़ चुका होंगा I</p>
                        <div class="flex flex-col sm:flex-row gap-2 sm:gap-3">
                            <input type="text" name="250" class="answer-input flex-1 px-3 sm:px-4 py-2 sm:py-3 rounded-lg border border-gray-300 focus:border-indigo-500 outline-none transition" placeholder="Enter Your Answer" aria-label="Translation for question 4">
                        ...
                        <div class="correct-answer mt-4 bg-green-50 border-l-4 border-green-500 p-4 rounded-r">
                            <p class="text-green-700 font-medium flex items-start gap-2">
                                <i class="fas fa-check-circle mt-1 text-green-500"></i>
                                <span>Most Appropriate Answer: <span class="font-normal">I will have fired all the cartridges.</span></span>
                            </p>
                        </div>
                        <div class="incorrect-answer mt-4 bg-red-50 border-l-4 border-red-500 p-4 rounded-r">
                            <p class="text-red-700 font-medium flex items-start gap-2">
                        ...
                        <input type="hidden" name="queId[]" value="250">
                    </div>
                </div>
            </div>
            ...
            <div class="question-card bg-white p-4 sm:p-6 rounded-3xl shadow-md border-l-4 border-indigo-500 mb-6" data-aos="fade-up" data-aos-delay="250">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        <p class="text-sm sm:text-lg font-medium text-gray-800 mb-4 hindi-text">क्या तुमने बाल कटवाए हैं?</p>
                        <div class="flex flex-col sm:flex-row gap-2 sm:gap-3">
                            <input type="text" name="251" class="answer-input flex-1 px-3 sm:px-4 py-2 sm:py-3 rounded-lg border border-gray-300 focus:border-indigo-500 outline-none transition" placeholder="Enter Your Answer" aria-label="Translation for question 5">
                        ...
                        <div class="correct-answer mt-4 bg-green-50 border-l-4 border-green-500 p-4 rounded-r">
                            <p class="text-green-700 font-medium flex items-start gap-2">
                                <i class="fas fa-check-circle mt-1 text-green-500"></i>
                                <span>Most Appropriate Answer: <span class="font-normal">Have you got your hair cut?</span></span>
                            </p>
                        </div>
                        <div class="incorrect-answer mt-4 bg-red-50 border-l-4 border-red-500 p-4 rounded-r">
                            <p class="text-red-700 font-medium flex items-start gap-2">
                        ...
                        <input type="hidden" name="queId[]" value="251">
                    </div>
                </div>
            </div>
            ...
            <div class="question-card bg-white p-4 sm:p-6 rounded-3xl shadow-md border-l-4 border-indigo-500 mb-6" data-aos="fade-up" data-aos-delay="300">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        <p class="text-sm sm:text-lg font-medium text-gray-800 mb-4 hindi-text">क्या वह थप्पड़ खा चुका था ?</p>
                        <div class="flex flex-col sm:flex-row gap-2 sm:gap-3">
                            <input type="text" name="252" class="answer-input flex-1 px-3 sm:px-4 py-2 sm:py-3 rounded-lg border border-gray-300 focus:border-indigo-500 outline-none transition" placeholder="Enter Your Answer" aria-label="Translation for question 6">
                        ...
                        <div class="correct-answer mt-4 bg-green-50 border-l-4 border-green-500 p-4 rounded-r">
                            <p class="text-green-700 font-medium flex items-start gap-2">
                                <i class="fas fa-check-circle mt-1 text-green-500"></i>
                                <span>Most Appropriate Answer: <span class="font-normal">Had he been slapped?</span></span>
                            </p>
                        </div>
                        <div class="incorrect-answer mt-4 bg-red-50 border-l-4 border-red-500 p-4 rounded-r">
                            <p class="text-red-700 font-medium flex items-start gap-2">
                        ...
                        <input type="hidden" name="queId[]" value="252">
                    </div>
                </div>
            </div>
            ...
            <div class="question-card bg-white p-4 sm:p-6 rounded-3xl shadow-md border-l-4 border-indigo-500 mb-6" data-aos="fade-up" data-aos-delay="350">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        <p class="text-sm sm:text-lg font-medium text-gray-800 mb-4 hindi-text">क्या मैं सही जवाबों के तुक्के लगा चुका होंगा?</p>
                        <div class="flex flex-col sm:flex-row gap-2 sm:gap-3">
                            <input type="text" name="253" class="answer-input flex-1 px-3 sm:px-4 py-2 sm:py-3 rounded-lg border border-gray-300 focus:border-indigo-500 outline-none transition" placeholder="Enter Your Answer" aria-label="Translation for question 7">
                        ...
                        <div class="correct-answer mt-4 bg-green-50 border-l-4 border-green-500 p-4 rounded-r">
                            <p class="text-green-700 font-medium flex items-start gap-2">
                                <i class="fas fa-check-circle mt-1 text-green-500"></i>
                                <span>Most Appropriate Answer: <span class="font-normal">Will I have guessed the correct answers?</span></span>
                            </p>
                        </div>
                        <div class="incorrect-answer mt-4 bg-red-50 border-l-4 border-red-500 p-4 rounded-r">
                            <p class="text-red-700 font-medium flex items-start gap-2">
                        ...
                        <input type="hidden" name="queId[]" value="253">
                    </div>
                </div>
            </div>
            ...
            <div class="question-card bg-white p-4 sm:p-6 rounded-3xl shadow-md border-l-4 border-indigo-500 mb-6" data-aos="fade-up" data-aos-delay="400">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        <p class="text-sm sm:text-lg font-medium text-gray-800 mb-4 hindi-text">मैं कविता पढ़ चुका हूँ I</p>
                        <div class="flex flex-col sm:flex-row gap-2 sm:gap-3">
                            <input type="text" name="254" class="answer-input flex-1 px-3 sm:px-4 py-2 sm:py-3 rounded-lg border border-gray-300 focus:border-indigo-500 outline-none transition" placeholder="Enter Your Answer" aria-label="Translation for question 8">
                        ...
                        <div class="correct-answer mt-4 bg-green-50 border-l-4 border-green-500 p-4 rounded-r">
                            <p class="text-green-700 font-medium flex items-start gap-2">
                                <i class="fas fa-check-circle mt-1 text-green-500"></i>
                                <span>Most Appropriate Answer: <span class="font-normal">I have read the poem.</span></span>
                            </p>
                        </div>
                        <div class="incorrect-answer mt-4 bg-red-50 border-l-4 border-red-500 p-4 rounded-r">
                            <p class="text-red-700 font-medium flex items-start gap-2">
                        ...
                        <input type="hidden" name="queId[]" value="254">
                    </div>
                </div>
            </div>
            ...
            <div class="question-card bg-white p-4 sm:p-6 rounded-3xl shadow-md border-l-4 border-indigo-500 mb-6" data-aos="fade-up" data-aos-delay="450">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        <p class="text-sm sm:text-lg font-medium text-gray-800 mb-4 hindi-text">उसने तुम पर ध्यान देना बंद कर दिया हैं I</p>
                        <div class="flex flex-col sm:flex-row gap-2 sm:gap-3">
                            <input type="text" name="255" class="answer-input flex-1 px-3 sm:px-4 py-2 sm:py-3 rounded-lg border border-gray-300 focus:border-indigo-500 outline-none transition" placeholder="Enter Your Answer" aria-label="Translation for question 9">
                        ...
                        <div class="correct-answer mt-4 bg-green-50 border-l-4 border-green-500 p-4 rounded-r">
                            <p class="text-green-700 font-medium flex items-start gap-2">
                                <i class="fas fa-check-circle mt-1 text-green-500"></i>
                                <span>Most Appropriate Answer: <span class="font-normal">He has stopped paying attention to you.</span></span>
                            </p>
                        </div>
                        <div class="incorrect-answer mt-4 bg-red-50 border-l-4 border-red-500 p-4 rounded-r">
                            <p class="text-red-700 font-medium flex items-start gap-2">
                        ...
                        <input type="hidden" name="queId[]" value="255">
                    </div>
                </div>
            </div>
            ...
            <div class="question-card bg-white p-4 sm:p-6 rounded-3xl shadow-md border-l-4 border-indigo-500 mb-6" data-aos="fade-up" data-aos-delay="500">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        <p class="text-sm sm:text-lg font-medium text-gray-800 mb-4 hindi-text">हम शराब ढ़ोल चुके थे I</p>
                        <div class="flex flex-col sm:flex-row gap-2 sm:gap-3">
                            <input type="text" name="256" class="answer-input flex-1 px-3 sm:px-4 py-2 sm:py-3 rounded-lg border border-gray-300 focus:border-indigo-500 outline-none transition" placeholder="Enter Your Answer" aria-label="Translation for question 10">
                        ...
                        <div class="correct-answer mt-4 bg-green-50 border-l-4 border-green-500 p-4 rounded-r">
                            <p class="text-green-700 font-medium flex items-start gap-2">
                                <i class="fas fa-check-circle mt-1 text-green-500"></i>
                                <span>Most Appropriate Answer: <span class="font-normal">We had searched for alcohol.</span></span>
                            </p>
                        </div>
                        <div class="incorrect-answer mt-4 bg-red-50 border-l-4 border-red-500 p-4 rounded-r">
                            <p class="text-red-700 font-medium flex items-start gap-2">
                        ...
                        <input type="hidden" name="queId[]" value="256">
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const correctAnswers = {
                '247': 'I have solved my problem.',
                '248': 'Geeta Phogat has brought glory to the country.',
                '249': 'Dad had deleted all the outdated mobile apps.',
                '250': 'I will have fired all the cartridges.',
                '251': 'Have you got your hair cut?',
                '252': 'Had he been slapped?',
                '253': 'Will I have guessed the correct answers?',
                '254': 'I have read the poem.',
                '255': 'He has stopped paying attention to you.',
                '256': 'We had searched for alcohol.'
            };
