...
<body class="bg-gray-50">
    ...
    <div class="container mx-auto px-2 sm:px-4 py-6 sm:py-8 max-w-full sm:max-w-4xl">
        ...
        <form id="quizForm" action="practicework.php?typeId=1&topicId=7" method="POST">
            <!-- Question 1 -->
            <div class="question-card bg-white p-4 sm:p-6 rounded-3xl shadow-md border-l-4 border-indigo-500 mb-6" data-aos="fade-up" data-aos-delay="50">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        <p class="text-sm sm:text-lg font-medium text-gray-800 mb-4 hindi-text">किससे अपनी समस्या बाटूँ ?</p>
                        <div class="flex flex-col sm:flex-row gap-2 sm:gap-3">
                            <input type="text" name="217" class="answer-input flex-1 px-3 sm:px-4 py-2 sm:py-3 rounded-lg border border-gray-300 focus:border-indigo-500 outline-none transition" placeholder="Enter Your Answer" aria-label="Translation for question 1">
                        ...
                        <div class="correct-answer mt-4 bg-green-50 border-l-4 border-green-500 p-4 rounded-r">
                            <p class="text-green-700 font-medium flex items-start gap-2">
                                ...
                                <span>Most Appropriate Answer: <span class="font-normal">With whom should I share my problem?</span></span>
                            </p>
                        </div>
                        ...
                        <input type="hidden" name="queId[]" value="217">
                    </div>
                </div>
            </div>
            ...
            <div class="question-card bg-white p-4 sm:p-6 rounded-3xl shadow-md border-l-4 border-indigo-500 mb-6" data-aos="fade-up" data-aos-delay="100">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        <p class="text-sm sm:text-lg font-medium text-gray-800 mb-4 hindi-text">मैं किसके साथ अँग्रेजी में बोलने का प्रयास करूँ?</p>
                        <div class="flex flex-col sm:flex-row gap-2 sm:gap-3">
                            <input type="text" name="218" class="answer-input flex-1 px-3 sm:px-4 py-2 sm:py-3 rounded-lg border border-gray-300 focus:border-indigo-500 outline-none transition" placeholder="Enter Your Answer" aria-label="Translation for question 2">
                        ...
                        <div class="correct-answer mt-4 bg-green-50 border-l-4 border-green-500 p-4 rounded-r">
                            <p class="text-green-700 font-medium flex items-start gap-2">
                                <i class="fas fa-check-circle mt-1 text-green-500"></i>
                                <span>Most Appropriate Answer: <span class="font-normal">With whom should I try to speak in English?</span></span>
                            </p>
                        </div>
                        <div class="incorrect-answer mt-4 bg-red-50 border-l-4 border-red-500 p-4 rounded-r">
                            <p class="text-red-700 font-medium flex items-start gap-2">
                        ...
                        <input type="hidden" name="queId[]" value="218">
                    </div>
                </div>
            </div>
            ...
            <div class="question-card bg-white p-4 sm:p-6 rounded-3xl shadow-md border-l-4 border-indigo-500 mb-6" data-aos="fade-up" data-aos-delay="150">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        <p class="text-sm sm:text-lg font-medium text-gray-800 mb-4 hindi-text">किस विचार को प्राथमिकता दूँ ?</p>
                        <div class="flex flex-col sm:flex-row gap-2 sm:gap-3">
                            <input type="text" name="219" class="answer-input flex-1 px-3 sm:px-4 py-2 sm:py-3 rounded-lg border border-gray-300 focus:border-indigo-500 outline-none transition" placeholder="Enter Your Answer" aria-label="Translation for question 3">
                        ...
                        <div class="correct-answer mt-4 bg-green-50 border-l-4 border-green-500 p-4 rounded-r">
                            <p class="text-green-700 font-medium flex items-start gap-2">
                                <i class="fas fa-check-circle mt-1 text-green-500"></i>
                                <span>Most Appropriate Answer: <span class="font-normal">Which idea should I prioritize?</span></span>
                            </p>
                        </div>
                        <div class="incorrect-answer mt-4 bg-red-50 border-l-4 border-red-500 p-4 rounded-r">
                            <p class="text-red-700 font-medium flex items-start gap-2">
                        ...
                        <input type="hidden" name="queId[]" value="219">
                    </div>
                </div>
            </div>
            ...
            <div class="question-card bg-white p-4 sm:p-6 rounded-3xl shadow-md border-l-4 border-indigo-500 mb-6" data-aos="fade-up" data-aos-delay="200">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        <p class="text-sm sm:text-lg font-medium text-gray-800 mb-4 hindi-text">मैं शादी में कोनसी ड्रेस पहनूँ ?</p>
                        <div class="flex flex-col sm:flex-row gap-2 sm:gap-3">
                            <input type="text" name="220" class="answer-input flex-1 px-3 sm:px-4 py-2 sm:py-3 rounded-lg border border-gray-300 focus:border-indigo-500 outline-none transition" placeholder="Enter Your Answer" aria-label="Translation for question 4">
                        ...
                        <div class="correct-answer mt-4 bg-green-50 border-l-4 border-green-500 p-4 rounded-r">
                            <p class="text-green-700 font-medium flex items-start gap-2">
                                <i class="fas fa-check-circle mt-1 text-green-500"></i>
                                <span>Most Appropriate Answer: <span class="font-normal">Which dress should I wear to the wedding?</span></span>
                            </p>
                        </div>
                        <div class="incorrect-answer mt-4 bg-red-50 border-l-4 border-red-500 p-4 rounded-r">
                            <p class="text-red-700 font-medium flex items-start gap-2">
                        ...
                        <input type="hidden" name="queId[]" value="220">
                    </div>
                </div>
            </div>
            ...
            <div class="question-card bg-white p-4 sm:p-6 rounded-3xl shadow-md border-l-4 border-indigo-500 mb-6" data-aos="fade-up" data-aos-delay="250">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        <p class="text-sm sm:text-lg font-medium text-gray-800 mb-4 hindi-text">किसके लिए खिलौने खरीदूँ ?</p>
                        <div class="flex flex-col sm:flex-row gap-2 sm:gap-3">
                            <input type="text" name="221" class="answer-input flex-1 px-3 sm:px-4 py-2 sm:py-3 rounded-lg border border-gray-300 focus:border-indigo-500 outline-none transition" placeholder="Enter Your Answer" aria-label="Translation for question 5">
                        ...
                        <div class="correct-answer mt-4 bg-green-50 border-l-4 border-green-500 p-4 rounded-r">
                            <p class="text-green-700 font-medium flex items-start gap-2">
                                <i class="fas fa-check-circle mt-1 text-green-500"></i>
                                <span>Most Appropriate Answer: <span class="font-normal">For whom should I buy toys?</span></span>
                            </p>
                        </div>
                        <div class="incorrect-answer mt-4 bg-red-50 border-l-4 border-red-500 p-4 rounded-r">
                            <p class="text-red-700 font-medium flex items-start gap-2">
                        ...
                        <input type="hidden" name="queId[]" value="221">
                    </div>
                </div>
            </div>
            ...
            <div class="question-card bg-white p-4 sm:p-6 rounded-3xl shadow-md border-l-4 border-indigo-500 mb-6" data-aos="fade-up" data-aos-delay="300">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        <p class="text-sm sm:text-lg font-medium text-gray-800 mb-4 hindi-text">हम क्यों उससे बात करे ?</p>
                        <div class="flex flex-col sm:flex-row gap-2 sm:gap-3">
                            <input type="text" name="222" class="answer-input flex-1 px-3 sm:px-4 py-2 sm:py-3 rounded-lg border border-gray-300 focus:border-indigo-500 outline-none transition" placeholder="Enter Your Answer" aria-label="Translation for question 6">
                        ...
                        <div class="correct-answer mt-4 bg-green-50 border-l-4 border-green-500 p-4 rounded-r">
                            <p class="text-green-700 font-medium flex items-start gap-2">
                                <i class="fas fa-check-circle mt-1 text-green-500"></i>
                                <span>Most Appropriate Answer: <span class="font-normal">Why should we talk to him?</span></span>
                            </p>
                        </div>
                        <div class="incorrect-answer mt-4 bg-red-50 border-l-4 border-red-500 p-4 rounded-r">
                            <p class="text-red-700 font-medium flex items-start gap-2">
                        ...
                        <input type="hidden" name="queId[]" value="222">
                    </div>
                </div>
            </div>
            ...
            <div class="question-card bg-white p-4 sm:p-6 rounded-3xl shadow-md border-l-4 border-indigo-500 mb-6" data-aos="fade-up" data-aos-delay="350">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        <p class="text-sm sm:text-lg font-medium text-gray-800 mb-4 hindi-text">कोनसा टॉपिक पढ़ाऊँ ?</p>
                        <div class="flex flex-col sm:flex-row gap-2 sm:gap-3">
                            <input type="text" name="223" class="answer-input flex-1 px-3 sm:px-4 py-2 sm:py-3 rounded-lg border border-gray-300 focus:border-indigo-500 outline-none transition" placeholder="Enter Your Answer" aria-label="Translation for question 7">
                        ...
                        <div class="correct-answer mt-4 bg-green-50 border-l-4 border-green-500 p-4 rounded-r">
                            <p class="text-green-700 font-medium flex items-start gap-2">
                                <i class="fas fa-check-circle mt-1 text-green-500"></i>
                                <span>Most Appropriate Answer: <span class="font-normal">Which topic should I teach?</span></span>
                            </p>
                        </div>
                        <div class="incorrect-answer mt-4 bg-red-50 border-l-4 border-red-500 p-4 rounded-r">
                            <p class="text-red-700 font-medium flex items-start gap-2">
                        ...
                        <input type="hidden" name="queId[]" value="223">
                    </div>
                </div>
            </div>
            ...
            <div class="question-card bg-white p-4 sm:p-6 rounded-3xl shadow-md border-l-4 border-indigo-500 mb-6" data-aos="fade-up" data-aos-delay="400">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        <p class="text-sm sm:text-lg font-medium text-gray-800 mb-4 hindi-text">परिवार के साथ कहाँ घूमने जाऊँ ?</p>
                        <div class="flex flex-col sm:flex-row gap-2 sm:gap-3">
                            <input type="text" name="224" class="answer-input flex-1 px-3 sm:px-4 py-2 sm:py-3 rounded-lg border border-gray-300 focus:border-indigo-500 outline-none transition" placeholder="Enter Your Answer" aria-label="Translation for question 8">
                        ...
                        <div class="correct-answer mt-1 bg-green-50 border-l-4 border-green-500 p-4 rounded-r">
                            <p class="text-green-700 font-medium flex items-start gap-2">
                                <i class="fas fa-check-circle mt-1 text-green-500"></i>
                                <span>Most Appropriate Answer: <span class="font-normal">Where should I go with family for an outing?</span></span>
                            </p>
                        </div>
                        <div class="incorrect-answer mt-4 bg-red-50 border-l-4 border-red-500 p-4 rounded-r">
                            <p class="text-red-700 font-medium flex items-start gap-2">
                        ...
                        <input type="hidden" name="queId[]" value="224">
                    </div>
                </div>
            </div>
            ...
            <div class="question-card bg-white p-4 sm:p-6 rounded-3xl shadow-md border-l-4 border-indigo-500 mb-6" data-aos="fade-up" data-aos-delay="450">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        <p class="text-sm sm:text-lg font-medium text-gray-800 mb-4 hindi-text">कितने तोहफ़े खरीदूँ ?</p>
                        <div class="flex flex-col sm:flex-row gap-2 sm:gap-3">
                            <input type="text" name="225" class="answer-input flex-1 px-3 sm:px-4 py-2 sm:py-3 rounded-lg border border-gray-300 focus:border-indigo-500 outline-none transition" placeholder="Enter Your Answer" aria-label="Translation for question 9">
                        ...
                        <div class="correct-answer mt-1 bg-green-50 border-l-4 border-green-500 p-4 rounded-r">
                            <p class="text-green-700 font-medium flex items-start gap-2">
                                <i class="fas fa-check-circle mt-1 text-green-500"></i>
                                <span>Most Appropriate Answer: <span class="font-normal">How many gifts should I buy?</span></span>
                            </p>
                        </div>
                        <div class="incorrect-answer mt-4 bg-red-50 border-l-4 border-red-500 p-4 rounded-r">
                            <p class="text-red-700 font-medium flex items-start gap-2">
                        ...
                        <input type="hidden" name="queId[]" value="225">
                    </div>
                </div>
            </div>
            ...
            <div class="question-card bg-white p-4 sm:p-6 rounded-3xl shadow-md border-l-4 border-indigo-500 mb-6" data-aos="fade-up" data-aos-delay="500">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        <p class="text-sm sm:text-lg font-medium text-gray-800 mb-4 hindi-text">किसका जूता पहनूँ ?</p>
                        <div class="flex flex-col sm:flex-row gap-2 sm:gap-3">
                            <input type="text" name="226" class="answer-input flex-1 px-3 sm:px-4 py-2 sm:py-3 rounded-lg border border-gray-300 focus:border-indigo-500 outline-none transition" placeholder="Enter Your Answer" aria-label="Translation for question 10">
                        ...
                        <div class="correct-answer mt-4 bg-green-50 border-l-4 border-green-500 p-4 rounded-r">
                            <p class="text-green-700 font-medium flex items-start gap-2">
                                <i class="fas fa-check-circle mt-1 text-green-500"></i>
                                <span>Most Appropriate Answer: <span class="font-normal">Whose shoes should I wear?</span></span>
                            </p>
                        </div>
                        <div class="incorrect-answer mt-4 bg-red-50 border-l-4 border-red-500 p-4 rounded-r">
                            <p class="text-red-700 font-medium flex items-start gap-2">
                        ...
                        <input type="hidden" name="queId[]" value="226">
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const correctAnswers = {
                '217': 'With whom should I share my problem?',
                '218': 'With whom should I try to speak in English?',
                '219': 'Which idea should I prioritize?',
                '220': 'Which dress should I wear to the wedding?',
                '221': 'For whom should I buy toys?',
                '222': 'Why should we talk to him?',
                '223': 'Which topic should I teach?',
                '224': 'Where should I go with family for an outing?',
                '225': 'How many gifts should I buy?',
                '226': 'Whose shoes should I wear?'
            };
