...
<head>
    ...
    <title>Ghyaan.com - English Grammar Quiz (Keep)</title>
        ...
        <form id="quizForm" action="practicework.php?typeId=3&topicId=4" method="POST">
            ...
            <div class="question-card bg-white rounded-lg shadow-md mb-6 overflow-hidden">
                <div class="p-6">
                    ...
                    <p class="mt-2 text-lg text-gray-700">She .............................. disturbing me in between.</p>
                    <div class="mt-4 space-y-3">
                        <div class="option p-3 rounded-md cursor-pointer" data-correct="false">
                            <input type="radio" name="87" id="q1-1" value="1" class="hidden" aria-checked="false">
                        ...
                        <div class="option p-3 rounded-md cursor-pointer" data-correct="true">
                            <input type="radio" name="87" id="q1-2" value="2" class="hidden" aria-checked="false">
                        ...
                        <div class="option p-3 rounded-md cursor-pointer" data-correct="false">
                            <input type="radio" name="87" id="q1-3" value="3" class="hidden" aria-checked="false">
                        ...
                        <div class="option p-3 rounded-md cursor-pointer" data-correct="false">
                            <input type="radio" name="87" id="q1-4" value="4" class="hidden" aria-checked="false">
                    ...
                    <input type="hidden" name="queId[]" value="87" id="queId">
                </div>
            </div>
            ...
            <div class="question-card bg-white rounded-lg shadow-md mb-6 overflow-hidden">
                <div class="p-6">
                    ...
                    <p class="mt-2 text-lg text-gray-700">.............................. Keep talking on meaningless topics.</p>
                    <div class="mt-4 space-y-3">
                        <div class="option p-3 rounded-md cursor-pointer" data-correct="true">
                            <input type="radio" name="88" id="q2-1" value="1" class="hidden" aria-checked="false">
                        ...
                        <div class="option p-3 rounded-md cursor-pointer" data-correct="false">
                            <input type="radio" name="88" id="q2-2" value="2" class="hidden" aria-checked="false">
                        ...
                        <div class="option p-3 rounded-md cursor-pointer" data-correct="false">
                            <input type="radio" name="88" id="q2-3" value="3" class="hidden" aria-checked="false">
                        ...
                        <div class="option p-3 rounded-md cursor-pointer" data-correct="false">
                            <input type="radio" name="88" id="q2-4" value="4" class="hidden" aria-checked="false">
                    ...
                    <input type="hidden" name="queId[]" value="88" id="queId">
                </div>
            </div>
            ...
            <div class="question-card bg-white rounded-lg shadow-md mb-6 overflow-hidden">
                <div class="p-6">
                    ...
                    <p class="mt-2 text-lg text-gray-700">He .............................. Disturbing me when I was speaking on stage.</p>
                    <div class="mt-4 space-y-3">
                        <div class="option p-3 rounded-md cursor-pointer" data-correct="false">
                            <input type="radio" name="89" id="q3-1" value="1" class="hidden" aria-checked="false">
                        ...
                        <div class="option p-3 rounded-md cursor-pointer" data-correct="true">
                            <input type="radio" name="89" id="q3-2" value="2" class="hidden" aria-checked="false">
                        ...
                        <div class="option p-3 rounded-md cursor-pointer" data-correct="false">
                            <input type="radio" name="89" id="q3-3" value="3" class="hidden" aria-checked="false">
                        ...
                        <div class="option p-3 rounded-md cursor-pointer" data-correct="false">
                            <input type="radio" name="89" id="q3-4" value="4" class="hidden" aria-checked="false">
                    ...
                    <input type="hidden" name="queId[]" value="89" id="queId">
                </div>
            </div>
            ...
            <div class="question-card bg-white rounded-lg shadow-md mb-6 overflow-hidden">
                <div class="p-6">
                    ...
                    <p class="mt-2 text-lg text-gray-700">Country will keep ..............................</p>
                    <div class="mt-4 space-y-3">
                        <div class="option p-3 rounded-md cursor-pointer" data-correct="false">
                            <input type="radio" name="90" id="q4-1" value="1" class="hidden" aria-checked="false">
                            <label for="q4-1" class="flex items-center cursor-pointer">
                                <span class="radio-circle"></span>
                                <span>Get developing</span>
                            </label>
                        </div>
                        <div class="option p-3 rounded-md cursor-pointer" data-correct="false">
                            <input type="radio" name="90" id="q4-2" value="2" class="hidden" aria-checked="false">
                        ...
                        <div class="option p-3 rounded-md cursor-pointer" data-correct="true">
                            <input type="radio" name="90" id="q4-3" value="3" class="hidden" aria-checked="false">
                        ...
                        <div class="option p-3 rounded-md cursor-pointer" data-correct="false">
                            <input type="radio" name="90" id="q4-4" value="4" class="hidden" aria-checked="false">
                            <label for="q4-4" class="flex items-center cursor-pointer">
                                <span class="radio-circle"></span>
                                <span>Getting developed</span>
                            </label>
                        </div>
                    </div>
                    <div class="feedback mt-3 text-sm">
                    ...
                    <input type="hidden" name="queId[]" value="90" id="queId">
                </div>
            </div>
            ...
            <div class="question-card bg-white rounded-lg shadow-md mb-6 overflow-hidden">
                <div class="p-6">
                    ...
                    <p class="mt-2 text-lg text-gray-700">My friends .............................. Gossiping.</p>
                    <div class="mt-4 space-y-3">
                        <div class="option p-3 rounded-md cursor-pointer" data-correct="true">
                            <input type="radio" name="91" id="q5-1" value="1" class="hidden" aria-checked="false">
                        ...
                        <div class="option p-3 rounded-md cursor-pointer" data-correct="false">
                            <input type="radio" name="91" id="q5-2" value="2" class="hidden" aria-checked="false">
                        ...
                        <div class="option p-3 rounded-md cursor-pointer" data-correct="false">
                            <input type="radio" name="91" id="q5-3" value="3" class="hidden" aria-checked="false">
                        ...
                        <div class="option p-3 rounded-md cursor-pointer" data-correct="false">
                            <input type="radio" name="91" id="q5-4" value="4" class="hidden" aria-checked="false">
                    ...
                    <input type="hidden" name="queId[]" value="91" id="queId">
                </div>
            </div>
            ...
            <div class="question-card bg-white rounded-lg shadow-md mb-6 overflow-hidden">
                <div class="p-6">
                    ...
                    <p class="mt-2 text-lg text-gray-700">History .............................. repeating itself.</p>
                    <div class="mt-4 space-y-3">
                        <div class="option p-3 rounded-md cursor-pointer" data-correct="false">
                            <input type="radio" name="92" id="q6-1" value="1" class="hidden" aria-checked="false">
                        ...
                        <div class="option p-3 rounded-md cursor-pointer" data-correct="false">
                            <input type="radio" name="92" id="q6-2" value="2" class="hidden" aria-checked="false">
                        ...
                        <div class="option p-3 rounded-md cursor-pointer" data-correct="true">
                            <input type="radio" name="92" id="q6-3" value="3" class="hidden" aria-checked="false">
                        ...
                        <div class="option p-3 rounded-md cursor-pointer" data-correct="false">
                            <input type="radio" name="92" id="q6-4" value="4" class="hidden" aria-checked="false">
                    ...
                    <input type="hidden" name="queId[]" value="92" id="queId">
                </div>
            </div>
            ...
            <div class="question-card bg-white rounded-lg shadow-md mb-6 overflow-hidden">
                <div class="p-6">
                    ...
                    <p class="mt-2 text-lg text-gray-700">In future People .............................. deceiving themselves.</p>
                    <div class="mt-4 space-y-3">
                        <div class="option p-3 rounded-md cursor-pointer" data-correct="true">
                            <input type="radio" name="93" id="q7-1" value="1" class="hidden" aria-checked="false">
                        ...
                        <div class="option p-3 rounded-md cursor-pointer" data-correct="false">
                            <input type="radio" name="93" id="q7-2" value="2" class="hidden" aria-checked="false">
                        ...
                        <div class="option p-3 rounded-md cursor-pointer" data-correct="false">
                            <input type="radio" name="93" id="q7-3" value="3" class="hidden" aria-checked="false">
                        ...
                        <div class="option p-3 rounded-md cursor-pointer" data-correct="false">
                            <input type="radio" name="93" id="q7-4" value="4" class="hidden" aria-checked="false">
                    ...
                    <input type="hidden" name="queId[]" value="93" id="queId">
                </div>
            </div>
            ...
            <div class="question-card bg-white rounded-lg shadow-md mb-6 overflow-hidden">
                <div class="p-6">
                    ...
                    <p class="mt-2 text-lg text-gray-700">Prime Minister keeps .............................. to .............................. other countries.</p>
                    <div class="mt-4 space-y-3">
                        <div class="option p-3 rounded-md cursor-pointer" data-correct="false">
                            <input type="radio" name="94" id="q8-1" value="1" class="hidden" aria-checked="false">
                            <label for="q8-1" class="flex items-center cursor-pointer">
                                <span class="radio-circle"></span>
                                <span>go, visiting</span>
                            </label>
                        </div>
                        <div class="option p-3 rounded-md cursor-pointer" data-correct="true">
                            <input type="radio" name="94" id="q8-2" value="2" class="hidden" aria-checked="false">
                            <label for="q8-2" class="flex items-center cursor-pointer">
                                <span class="radio-circle"></span>
                                <span>going, visit</span>
                            </label>
                        </div>
                        <div class="option p-3 rounded-md cursor-pointer" data-correct="false">
                            <input type="radio" name="94" id="q8-3" value="3" class="hidden" aria-checked="false">
                            <label for="q8-3" class="flex items-center cursor-pointer">
                                <span class="radio-circle"></span>
                                <span>going, visiting</span>
                            </label>
                        </div>
                        <div class="option p-3 rounded-md cursor-pointer" data-correct="false">
                            <input type="radio" name="94" id="q8-4" value="4" class="hidden" aria-checked="false">
                    ...
                    <input type="hidden" name="queId[]" value="94" id="queId">
                </div>
            </div>
            ...
            <div class="question-card bg-white rounded-lg shadow-md mb-6 overflow-hidden">
                <div class="p-6">
                    ...
                    <p class="mt-2 text-lg text-gray-700">.............................. Keep .............................. with each-another.</p>
                    <div class="mt-4 space-y-3">
                        <div class="option p-3 rounded-md cursor-pointer" data-correct="false">
                            <input type="radio" name="95" id="q9-1" value="1" class="hidden" aria-checked="false">
                            <label for="q9-1" class="flex items-center cursor-pointer">
                                <span class="radio-circle"></span>
                                <span>He, fighting</span>
                            </label>
                        </div>
                        <div class="option p-3 rounded-md cursor-pointer" data-correct="false">
                            <input type="radio" name="95" id="q9-2" value="2" class="hidden" aria-checked="false">
                        ...
                        <div class="option p-3 rounded-md cursor-pointer" data-correct="true">
                            <input type="radio" name="95" id="q9-3" value="3" class="hidden" aria-checked="false">
                            <label for="q9-3" class="flex items-center cursor-pointer">
                                <span class="radio-circle"></span>
                                <span>They, fighting</span>
                            </label>
                        </div>
                        <div class="option p-3 rounded-md cursor-pointer" data-correct="false">
                            <input type="radio" name="95" id="q9-4" value="4" class="hidden" aria-checked="false">
                    ...
                    <input type="hidden" name="queId[]" value="95" id="queId">
                </div>
            </div>
            ...
            <div class="question-card bg-white rounded-lg shadow-md mb-6 overflow-hidden">
                <div class="p-6">
                    ...
                    <p class="mt-2 text-lg text-gray-700">Virat Kohli .............................. Centuries.</p>
                    <div class="mt-4 space-y-3">
                        <div class="option p-3 rounded-md cursor-pointer" data-correct="false">
                            <input type="radio" name="96" id="q10-1" value="1" class="hidden" aria-checked="false">
                            <label for="q10-1" class="flex items-center cursor-pointer">
                                <span class="radio-circle"></span>
                                <span>will keep hit</span>
                            </label>
                        </div>
                        <div class="option p-3 rounded-md cursor-pointer" data-correct="false">
                            <input type="radio" name="96" id="q10-2" value="2" class="hidden" aria-checked="false">
                        ...
                        <div class="option p-3 rounded-md cursor-pointer" data-correct="false">
                            <input type="radio" name="96" id="q10-3" value="3" class="hidden" aria-checked="false">
                            <label for="q10-3" class="flex items-center cursor-pointer">
                                <span class="radio-circle"></span>
                                <span>keep hitting</span>
                            </label>
                        </div>
                        <div class="option p-3 rounded-md cursor-pointer" data-correct="true">
                            <input type="radio" name="96" id="q10-4" value="4" class="hidden" aria-checked="false">
                            <label for="q10-4" class="flex items-center cursor-pointer">
                                <span class="radio-circle"></span>
                                <span>keeps hitting</span>
                            </label>
                        </div>
                    </div>
                    <div class="feedback mt-3 text-sm">
                    ...
                    <input type="hidden" name="queId[]" value="96" id="queId">
                </div>
            </div>
